...
public class Main
{
    static int iloscRamek = 200;
    static int iloscStron = 50;
    static int iloscOdwolan = 10000;
    static ArrayList<PamiecWirtualna> strony = new ArrayList<PamiecWirtualna>();
    static ArrayList<Integer> odwolania = new ArrayList<Integer>();
    Random r = new Random();
